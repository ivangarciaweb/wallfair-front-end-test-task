...
import { ReactComponent as IconBall } from "../../data/icons/basketball-ball.svg";
import { ReactComponent as IconCalendar } from "../../data/icons/calendar.svg";
import { ReactComponent as IconCelebrities } from "../../data/icons/celebrities.svg";
...
import { ReactComponent as IconESports } from "../../data/icons/eSports.svg";
import { ReactComponent as IconInfo } from "../../data/icons/info.svg";
import { ReactComponent as IconLogo } from "../../data/icons/logo.svg";
...
import { ReactComponent as IconTribune } from "../../data/icons/tribune.svg";
...
const Icon = ({
    ...
    const renderIcon = () => {
        return SelectionHelper.get(iconType, {
            ...
            [IconType.ball]: <IconBall />,
            [IconType.calendar]: <IconCalendar />,
            [IconType.celebrities]: <IconCelebrities />,
        ...
        <span
            ...
            className={classNames(
                ...
                SelectionHelper.get(iconTheme, {
                    ...
                    [IconTheme.whiteFill]: styles.iconWhiteFill,
                }),
